  ...
  context([
    ...
    describe('src/Model', function () {
      ...
      describe('Model class', function () {
        ...
        it('has `setupFacet` method which does nothing in case of facet ' +
           'hooks are functions', function () {
        ...
        it('has `setupFacet` method which replace functors class references ' +
           'by functor instances', function () {
      ...
      describe('Model instances', function () {
        ...
        it('have a `traverse()` method to implement a simple visitor.',
        function() {
          var model = new Model(),
